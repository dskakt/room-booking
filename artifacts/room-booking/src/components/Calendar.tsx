...
const SLOTS = [
  ...
  { id: BookingTimeSlot.slot4, label: '4限', time: '15:25-17:05' },
  { id: BookingTimeSlot.slot5, label: '5限以降', time: '17:15-' },
] as const;
                    ...
                    <tr key={`${day.dateStr}-${slot.id}`} className="group/row">
                      {isFirstSlot && (
                        <td 
                          ...
                          className={cn(
                            "sticky left-0 z-10 bg-white border-r border-b border-slate-200 p-4 align-top text-center font-medium shadow-[1px_0_0_0_#e2e8f0]",
